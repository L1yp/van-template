<template>
  <el-row>
    ...
    <ElCol :span="12" :xs="24" required>
      <ElFormItem label="序号" prop="orderNo">
...
import { ElCol, ElFormItem, ElInput, ElInputNumber, ElRow, ElTreeSelect } from "element-plus";
...
const parentOptions = computed<MenuOutputDTO[]>(() => {
  ...
  const filterTree = flatTree.filter(it => it.type === MenuType.Folder)
